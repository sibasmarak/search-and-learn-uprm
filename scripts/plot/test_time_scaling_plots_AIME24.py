...
seed_subsets = [
    "HuggingFaceH4_aime_2024--T-0.8--top_p-1.0--n-256--seed-0--agg_strategy-last--evals",
    "HuggingFaceH4_aime_2024--T-0.8--top_p-1.0--n-256--seed-1--agg_strategy-last--evals",
    "HuggingFaceH4_aime_2024--T-0.8--top_p-1.0--n-256--seed-2--agg_strategy-last--evals",
]
...
zero_shot_refs = {"Llama-3.2-1B-Instruct": [
    # ("Llama 3.2 1B", 3.3), # hiding this because it is the same as Llama-3.1-8B-Instruct
    ("Llama 3.1 8B", 3.3),
    ("Llama 3.1 70B", 20.0),
],
...
"Qwen2.5-7B-Instruct": [
    ...
    ("Qwen2.5 14B", 23.3),
    ("Qwen2.5 32B", 26.7),
    # ("Qwen2.5 72B", 16.7), # weird, not sure why this is so low, tried twice
],
